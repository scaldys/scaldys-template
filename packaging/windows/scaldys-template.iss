...
; The active mode is set via deployment_mode in scaldys-project.toml and controls
...
;     Set in scaldys-project.toml:  deployment_mode = "pyinstaller"
;
...
;     Set in scaldys-project.toml:  deployment_mode = "pyruntime"
...
;         Set in scaldys-project.toml:  bundle_pyruntime = true
;
;   Mode 3 -- wheel_only:
...
;     Set in scaldys-project.toml:  deployment_mode = "wheel_only"
