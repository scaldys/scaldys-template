...
the internal module layout::
    ...
    from scaldys_template.tk.ui import AnalyzerFrame, UiExamplesFrame, NavigationFrame, NavigationPanel
"""
...
__all__ = ["AnalyzerFrame", "UiExamplesFrame", "NavigationFrame", "NavigationPanel"]
